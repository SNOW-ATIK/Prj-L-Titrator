...
namespace L_Titrator.Controls
{
    public partial class UsrCtrl_TitrationGraph : UserControl
    {
        ...
        private string CurDisplaySampleName = "";
        ...
        public void Init_Background(RecipeObj rcpObj, bool showLabel = true)
        {
            ...
            btn_Prev.Visible = GraphDic.Count > 1;
            btn_Next.Visible = GraphDic.Count > 1;

            chk_Include_1st_mV.Checked = true;
            chk_Include_1st_mV.Enabled = false;

            CurDisplaySampleName = ValidTitrationStep[0].Name;
        }
        ...
        public void Init_Background(string sampleName, bool showLabel = true)
        {
            ...
            xyDiagram.AxisX.Title.Font = new Font("Consolas", 10f, FontStyle.Regular);
            xyDiagram.AxisY.Title.Font = new Font("Consolas", 10f, FontStyle.Regular);
            xyDiagram.AxisX.Title.Text = "Injection Volume [mL]";
            xyDiagram.AxisY.Title.Text = "Sensor Output [mV]";
            ...
            CurDisplaySampleName = sampleName;
        }
        ...
        public void AddPoint(string tgtName, double injVol, double analog_mV)
        {
            ...
            string tmp = injVol.ToString("0.00##");
            double dTmp = double.Parse(tmp);
            GraphDic[tgtName].Series[tgtName].Points.AddPoint(dTmp, analog_mV);
        ...
        {
            var series = GraphDic[CurDisplaySampleName].Series[CurDisplaySampleName];
            double dMinVal = 0;
            double dMaxVal = double.Parse(series.Points[series.Points.Count - 1].Argument);
            var diagram = (XYDiagram)GraphDic[CurDisplaySampleName].Diagram;
        ...
        {
            if (GraphDic[CurDisplaySampleName].Series[CurDisplaySampleName].Points.Count == 0)
            {
                return;
            }
            Set_GraphRange();
        ...
        {
            XYDiagram xyDiagram = (XYDiagram)GraphDic[CurDisplaySampleName].Diagram;
            xyDiagram.ZoomIn();
        }
